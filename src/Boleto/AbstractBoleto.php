...
namespace PhpBoleto\Boleto;

use Carbon\Carbon;
use PhpBoleto\Boleto\Render\Html;
    ...
    public function toArray()
    {
        return array_merge(
            [
                ...
                'beneficiario' => [
                    'nome' => $this->getBeneficiario()->getName(),
                    'endereco' => $this->getBeneficiario()->getAddress(),
                    'bairro' => $this->getBeneficiario()->getAddressDistrict(),
                    'cep' => $this->getBeneficiario()->getPostalCode(),
                    'uf' => $this->getBeneficiario()->getStateUf(),
                    'cidade' => $this->getBeneficiario()->getCity(),
                    'documento' => $this->getBeneficiario()->getDocument(),
                    'nome_documento' => $this->getBeneficiario()->getNameAndDocument(),
                    'endereco2' => $this->getBeneficiario()->getPostalCodeCityAndStateUf(),
                ],
                ...
                'sacador_avalista' =>
                    $this->getSacadorAvalista()
                        ? [
                        'nome' => $this->getPagador()->getName(),
                        'endereco' => $this->getPagador()->getAddress(),
                        'bairro' => $this->getPagador()->getAddressDistrict(),
                        'cep' => $this->getPagador()->getPostalCode(),
                        'uf' => $this->getPagador()->getStateUf(),
                        'cidade' => $this->getPagador()->getCity(),
                        'documento' => $this->getPagador()->getDocument(),
                        'nome_documento' => $this->getPagador()->getNameAndDocument(),
                        'endereco2' => $this->getPagador()->getPostalCodeCityAndStateUf(),
                    ]
                        : [],
                'pagador' => [
                    'nome' => $this->getPagador()->getName(),
