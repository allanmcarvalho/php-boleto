...
namespace PhpBoleto\Boleto\Render;

use PhpBoleto\Contracts\Boleto\Boleto as BoletoContract;
use PhpBoleto\Contracts\Boleto\Render\Pdf as PdfContract;
use PhpBoleto\Util;
...
class Pdf extends AbstractPdf implements PdfContract
{
    ...
    protected function comprovante($i)
    {
        ...
        if ($this->showComprovante) {
            ...
            $this->textFitCell(60, $this->cell, $this->_($this->boleto[$i]->getBeneficiario()->getName()), 'LR', 0, 'L');
            ...
            $this->SetFont($this->PadraoFont, 'B', $this->fcel);
            $this->Cell(60, $this->cell, $this->_($this->boleto[$i]->getPagador()->getName()), 'LR');
    ...
    protected function logoEmpresa($i)
    {
        ...
        $this->Cell(56);
        $this->Cell(0, $this->desc, $this->_($this->boleto[$i]->getBeneficiario()->getName()), 0, 1);
        $this->Cell(56);
        $this->Cell(0, $this->desc, $this->_($this->boleto[$i]->getBeneficiario()->getDocument(), '##.###.###/####-##'), 0, 1);
        $this->Cell(56);
        $this->Cell(0, $this->desc, $this->_($this->boleto[$i]->getBeneficiario()->getAddress()), 0, 1);
        $this->Cell(56);
        $this->Cell(0, $this->desc, $this->_($this->boleto[$i]->getBeneficiario()->getPostalCodeCityAndStateUf()), 0, 1);
        $this->Ln(8);
    ...
    protected function Topo($i)
    {
        ...
        $this->textFitCell(75, $this->cell, $this->_($this->boleto[$i]->getBeneficiario()->getName()), 'LR', 0, 'L');
        ...
        $this->Cell(40, $this->cell, $this->_($this->boleto[$i]->getBeneficiario()->getDocument(), '##.###.###/####-##'), 'R');
        ...
        $this->SetFont($this->PadraoFont, 'B', $this->fcel);
        $this->Cell(0, $this->cell, $this->_($this->boleto[$i]->getPagador()->getNameAndDocument()), 'BLR', 1);
    ...
    protected function Bottom($i)
    {
        ...
        $this->SetFont($this->PadraoFont, 'B', $this->fcel);
        $this->Cell(120, $this->cell, $this->_($this->boleto[$i]->getBeneficiario()->getNameAndDocument()), 'LR');
        ...
        $this->SetFont($this->PadraoFont, 'B', $this->fcel);
        $this->Cell(0, $this->cell, $this->_($this->boleto[$i]->getPagador()->getNameAndDocument()), 'LR', 1);
        $this->Cell(0, $this->cell, $this->_(trim($this->boleto[$i]->getPagador()->getAddress() . ' - ' . $this->boleto[$i]->getPagador()->getAddressDistrict()), ' -'), 'LR', 1);
        $this->Cell(0, $this->cell, $this->_($this->boleto[$i]->getPagador()->getPostalCodeCityAndStateUf()), 'LR', 1);
        ...
        $this->Cell(98, $this->desc, $this->_($this->boleto[$i]->getSacadorAvalista() ? $this->boleto[$i]->getSacadorAvalista()->getNameAndDocument() : ''), 0);
