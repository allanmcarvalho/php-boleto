...
class Hsbc extends AbstractRemessa implements RemessaContract
{
    ...
    public function addBoleto(BoletoContract $boleto)
    {
        ...
        $this->add(275, 312, Util::formatCnab('X', $boleto->getPagador()->getAddress(), 38));
        $this->add(313, 314, '00');
        ...
        $this->add(352, 390, Util::formatCnab('X', $boleto->getSacadorAvalista() ? $boleto->getSacadorAvalista()->getName() : '', 39));
        $this->add(391, 391, '');
