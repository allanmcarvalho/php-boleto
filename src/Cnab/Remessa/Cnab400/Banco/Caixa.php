...
class Caixa  extends AbstractRemessa implements RemessaContract
{
    ...
    public function addBoleto(BoletoContract $boleto)
    {
        ...
        $this->add(327, 334, Util::formatCnab('9L', $boleto->getPagador()->getPostalCode(), 8));
        ...
        $this->add(368, 389, Util::formatCnab('X', $boleto->getSacadorAvalista() ? $boleto->getSacadorAvalista()->getName() : '', 22));
        $this->add(390, 391, '00');
