...
namespace PhpBoleto\Cnab\Returns\Cnab240\Bank;

use Exception;
use PhpBoleto\Cnab\Returns\Cnab240\AbstractRetorno;
use PhpBoleto\Interfaces\Cnab\RetornoCnabInterface240;
use PhpBoleto\Interfaces\Slip\SlipInterface as BoletoContract;
use PhpBoleto\Util;

class Bancoob extends AbstractRetorno implements RetornoCnabInterface240
{
    /**
     * Código do banco
     *
    ...
    private $rejeicoes = [
        ...
        '50' => 'CEP Referente a um Banks Correspondente',
        ...
        '55' => 'Nosso número no Banks Correspondente Não Informado',
        '56' => 'Código do Banks Correspondente Não Informado',
        ...
        '65' => 'Código do Banks para Débito Inválido',
