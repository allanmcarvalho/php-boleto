...
class Bradesco extends AbstractRetorno implements RetornoCnabInterface400
{
    /**
     * Código do banco
     *
    ...
    private $ocorrencias = [
        ...
        "09" => "Baixado Automat. via Archive",
        "10" => "Baixado conforme instruções da Agência",
        "11" => "Em Ser - Archive de Títulos pendentes (sem motivo)",
