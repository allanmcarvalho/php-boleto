...
class Santander extends AbstractRetorno implements RetornoCnabInterface400
{
    ...
    private $rejeicoes = [
        ...
        '007' => 'Species do documento invalida',
        ...
        '059' => 'Instructions aceita so p/ cobranca simples',
        '060' => 'Species documento nao protestavel',
        ...
        '096' => 'Species docto nao permite protesto',
        '097' => 'Species docto nao permite ioc zerado',
