...
use PhpBoleto\Cnab\Remittances\Cnab240\AbstractRemessa;
...
class Santander extends AbstractRemessa implements RemessaContract
{
    ...
    protected function segmentoP($nSequencialLote, BoletoContract $boleto)
    {
        ...
        $this->add(45, 57, Util::formatCnab(9, $boleto->getOurNumber(), 13)); // Nosso Número
        ...
        //
        $this->add(63, 77, Util::formatCnab(9, $boleto->getControlNumber(), 15)); // Seu Número
        ...
        $this->add(143, 150, Util::formatCnab(9, $boleto->getDiscountDate()->format('dmY'), 8)); //Data de desconto 1
    ...
    protected function header()
    {
        ...
        $this->add(17, 17, strlen(Util::onlyNumbers($this->getBeneficiario()->getDocument())) == 14 ? '2' : '1'); // Tipo de inscrição da empresa
        $this->add(18, 32, Util::formatCnab('9L', $this->getBeneficiario()->getDocument(), 14)); // Numero de inscrição da empresa
        $this->add(33, 47, Util::formatCnab(9, $this->getCodigoTransmissao(), 15)); // Codigo de Transmissão
        $this->add(48, 72, ''); // Reservados (Uso Banco)
        $this->add(73, 102, Util::formatCnab('X', $this->getBeneficiario()->getName(), 30)); // Nome da empresa
    ...
    protected function headerLote()
    {
        ...
        $this->add(18, 18, strlen(Util::onlyNumbers($this->getBeneficiario()->getDocument())) == 14 ? '2' : '1'); // Tipo de inscrição da empresa
        $this->add(19, 33, Util::formatCnab('9L', $this->getBeneficiario()->getDocument(), 14)); // Numero de inscrição da empresa
        ...
        $this->add(74, 103, Util::formatCnab('X', $this->getBeneficiario()->getName(), 30)); // Nome do cedente
